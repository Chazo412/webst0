"""
Django settings for testwb project.
...
WSGI_APPLICATION = 'testwb.wsgi.application'
...
CACHE_MIDDLEWARE_SECONDS = 60  # Cache duration in seconds (60 seconds)
